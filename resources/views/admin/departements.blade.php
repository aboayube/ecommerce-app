                        ...
                        <table class="table table-hover table-bordered table-arabic" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $departement->name_en }}</td>
                                    <td>{{ $departement->user->name }}</td>
                                    <td>{{ $departement->status ? 'مفعل':'غير مفعل'}}</td>
                                    <td>
                                        @if($departement->user_id==auth()->id() )
                                        <a class="modal-effect btn btn-sm btn-info" data-id="{{ $departement->id }}" data-toggle="modal" id="showEditModelCategory" href="showEditModelCategory" title="تعديل"><i class="fa fa-edit"></i></a>
                                        <a class="modal-effect btn btn-sm btn-danger" data-id="{{ $departement->id }}" data-name="{{$departement->name}}" data-toggle="modal" id="showDeleteModelCategory" href="showDeleteModelCategory" title="حذف"><i class="fa fa-trash"></i></a>
                                        @endif
                                    </td>
                                    @endforeach
                                </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('admin.departments.update')}}" method="POST" enctype="multipart/form-data">
...
<script>
    $('body').on('click', '#showEditModelCategory', function() {
        ...
        $.get('/admin/departments/edit/' + cat_id, function(data) {
