...
{
    use HasFactory;
    protected $fillable = ['name', 'name_en', 'image', 'product_number', 'discription', 'discription_en', 'url', 'count', 'vendor_name', 'country', 'city', 'phone', 'whatsapp', 'type', 'status', 'user_id', 'category_id'];
